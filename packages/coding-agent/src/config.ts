...
export function getUpdateInstruction(packageName: string): string {
	...
	switch (method) {
		case "bun-binary":
			return `Download from: https://github.com/havasik/hotpi/releases/latest`;
		case "pnpm":
...
export function getPackageDir(): string {
	...
	const envDir = process.env.HOTPI_PACKAGE_DIR;
	if (envDir) {
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.HOTPI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
