...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@havasik/tui";
...
const THEME_KEY = Symbol.for("@havasik/hotpi:theme");
...
export function getSettingsListTheme(): import("@havasik/tui").SettingsListTheme {
	return {
