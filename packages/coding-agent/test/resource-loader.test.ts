...
Prompt content.`,
		...
		it("should prefer project resources over user on name collisions", async () => {
			...
			const projectPromptsDir = join(cwd, ".hotpi", "prompts");
			...
			const projectSkillDir = join(cwd, ".hotpi", "skills", "collision-skill");
...
Project skill`,
			...
			const projectThemePath = join(cwd, ".hotpi", "themes", "collision.json");
			mkdirSync(join(agentDir, "themes"), { recursive: true });
			mkdirSync(join(cwd, ".hotpi", "themes"), { recursive: true });
		...
		it("should keep both extensions loaded when command names collide", async () => {
			...
			const projectExtDir = join(cwd, ".hotpi", "extensions");
...
Content`,
		...
		it("should discover SYSTEM.md from cwd/.hotpi", async () => {
			const piDir = join(cwd, ".hotpi");
