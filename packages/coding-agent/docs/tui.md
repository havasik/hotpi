...
**Source:** [`@havasik/tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@havasik/tui";
...
```typescript
import { Container, type Focusable, Input } from "@havasik/tui";
...
Import from `@havasik/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@havasik/tui";
```
...
```typescript
import { matchesKey, Key } from "@havasik/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@havasik/tui";
...
```typescript
import { getMarkdownTheme } from "@havasik/hotpi";
import { Markdown } from "@havasik/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@havasik/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@havasik/hotpi";
import { DynamicBorder } from "@havasik/hotpi";
import { Container, type SelectItem, SelectList, Text } from "@havasik/tui";
...
```typescript
import { BorderedLoader } from "@havasik/hotpi";
...
For toggling multiple settings. Use `SettingsList` from `@havasik/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@havasik/hotpi";
import { Container, type SettingItem, SettingsList, Text } from "@havasik/tui";
...
import { matchesKey, truncateToWidth } from "@havasik/tui";
