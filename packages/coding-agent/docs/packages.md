...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@havasik/ai`, `@havasik/agent-core`, `@havasik/hotpi`, `@havasik/tui`, `@sinclair/typebox`.
