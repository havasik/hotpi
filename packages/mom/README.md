...
- run interactive coding agent session: `npx @havasik/hotpi`
- enter `/login` command
...
Update mom anytime with `npm install -g @havasik/mom`. This only updates the Node.js app on your host. Anything mom installed inside the Docker container remains unchanged.
