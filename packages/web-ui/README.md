...
Reusable web UI components for building AI chat interfaces powered by [@havasik/ai](../ai) and [@havasik/agent-core](../agent).
...
```bash
npm install @havasik/web-ui @havasik/agent-core @havasik/ai
```
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@havasik/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@havasik/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@havasik/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@havasik/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@havasik/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@havasik/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@havasik/web-ui';
...
```typescript
import { SessionListDialog } from '@havasik/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@havasik/web-ui';
...
```typescript
import { ModelSelector } from '@havasik/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@havasik/web-ui';
